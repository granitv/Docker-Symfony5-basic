 ...
 */
class getAppsRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AppsRepository' shared autowired service.
     *
     * @return \App\Repository\AppsRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AppsRepository.php';

        return $container->privates['App\\Repository\\AppsRepository'] = new \App\Repository\AppsRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
